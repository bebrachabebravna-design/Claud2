...
CSS;
    ...
    return $head."\n<style>$css</style>\n<!-- Яндекс.Метрика: 1) зарегистрируйте счётчик на metrika.yandex.ru, 2) замените XXXXXX на номер счётчика, 3) уберите комментарии <!НАЧАЛО и КОНЕЦ!> вокруг кода.
...
function render_index(array $posts): string {
    ...
    $extra = '<meta name="keywords" content="блог про ии, автоматизация бизнеса, нейросети для компаний, как автоматизировать работу с документами, как автоматизировать документооборот, как навести порядок в документах, как быстро найти документ в компании, сотрудники долго ищут информацию, как сократить время на поиск документов, как разгрузить сотрудников от рутины, как автоматизировать рутину в бизнесе, как ускорить ответы клиентам, как передать знания при увольнении сотрудника, как быстро адаптировать новых сотрудников, как подготовиться к проверке документов, как автоматизировать поддержку сотрудников, как внедрить ии в компанию, искусственный интеллект для бизнеса, нейросети для бизнеса, автоматизация бизнес-процессов">';
    // Blog schema
