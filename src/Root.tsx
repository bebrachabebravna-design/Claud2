...
import { HYBRID_DURATION, ReelHybrid } from "./pronin/ReelHybrid";
import { CIFRA_DURATION, ReelCifra } from "./pronin/ReelCifra";
import { NOFACE_DURATION, ReelNoFace } from "./pronin/ReelNoFace";
...
export const RemotionRoot: React.FC = () => {
  return (
    <>
      <Composition
        id="ReelNoFace"
        component={ReelNoFace}
        durationInFrames={NOFACE_DURATION}
        fps={30}
        width={1080}
        height={1920}
      />
      <Composition
        id="ReelCifra"
        component={ReelCifra}
        durationInFrames={CIFRA_DURATION}
        fps={30}
        width={1080}
        height={1920}
      />
